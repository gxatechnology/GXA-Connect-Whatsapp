...
import { Send, CheckCircle, XCircle, Loader2, Upload, X, Plus, Smartphone } from 'lucide-react';
import {
  messageApi,
  contactApi,
...
export function MessageTester() {
  ...
  useDocumentTitle('GXA Connect — Message Center');
  ...
  if (sessions.length === 0) {
    return (
      <div className="message-tester">
        <PageHeader title="Message Center" subtitle="Direct, group, and bulk message dispatch via connected WhatsApp accounts." />
        <div style={{ marginTop: '1.5rem' }}>
          <EmptyState
            icon={Smartphone}
            title="No WhatsApp Accounts Connected"
            description="Link a WhatsApp account to start sending direct, media, and group messages."
            action={
        ...
        <div className="response-panel">
          ...
          {response ? (
            <>
              ...
              <details className="response-json-details" style={{ marginTop: '1rem', borderTop: '1px solid var(--border)', paddingTop: '0.75rem' }}>
                <summary style={{ cursor: 'pointer', fontWeight: 600, fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Advanced Details</summary>
                <div className="response-json" style={{ marginTop: '0.5rem' }}>
