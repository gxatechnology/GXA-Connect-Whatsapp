        ...
        >
          <div className="detail-grid">
            ...
            <div className="detail-item">
              ...
              <StatusBadge status={selectedSession.status} label={formatStatus(selectedSession.status)} />
            </div>
            <div className="detail-item">
          ...
          filteredSessions.map(session => (
            <div key={session.id} className="session-card">
              <div className="card-header">
                ...
                <StatusBadge status={session.status} label={formatStatus(session.status)} />
              </div>
