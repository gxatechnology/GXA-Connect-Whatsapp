...
export class BulkMessageService implements OnApplicationBootstrap {
  ...
  async createBatch(sessionId: string, dto: SendBulkMessageDto, organizationId = 'org-platform-default'): Promise<MessageBatch> {
  ...
  async listBatches(sessionId: string, limit = 100): Promise<MessageBatch[]> {
